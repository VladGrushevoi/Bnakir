...
public class ConfirmTransactionHandler : IRequestHandler<ConfirmTransactionRequest, ConfirmTransactionResponse>
{
    ...
    public ConfirmTransactionHandler(IMapper mapper, IKisaMainRepository kisaMainRepository,
        ICardRepository cardRepository, IUnitOfWork unitOfWork)
    {
        _mapper = mapper;
    ...
    public async Task<ConfirmTransactionResponse> Handle(ConfirmTransactionRequest request,
