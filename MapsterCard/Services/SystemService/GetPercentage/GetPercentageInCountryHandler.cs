...
public sealed record GetPercentageInCountryRequest : IRequest<GetPercentageInCountryResponse>;
...
public sealed class
    GetPercentageInCountryHandler : IRequestHandler<GetPercentageInCountryRequest, GetPercentageInCountryResponse>
{
    ...
    public async Task<GetPercentageInCountryResponse> Handle(GetPercentageInCountryRequest request,
